...
2. Follow the **Saving Artefacts** rules in `.github/copilot-instructions.md` — ask where to save before writing anything. Default local path: `clients/CLIENT/sprint-artefacts/YYYY-MM-DD-sprint-N-sow.md`