...
2. Follow the **Saving Artefacts** rules in `AGENTS.md` — ask where to save before writing anything. Default local path: `clients/CLIENT/sprint-artefacts/YYYY-MM-DD-sprint-N-plan.md`
