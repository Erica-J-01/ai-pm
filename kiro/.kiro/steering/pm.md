...
|---|---|---|
| `.kiro/skills/pm-triage/SKILL.md` | Structured intake summary | No — must run first if input is raw |
| `.kiro/skills/pm-risk-scan/SKILL.md` | Risk register with scoring and owners | Yes — can run alongside charter |
| `.kiro/skills/pm-charter/SKILL.md` | Sponsor-ready project charter | After intake |
| `.kiro/skills/pm-discovery/SKILL.md` | Discovery plan and output | After charter |
| `.kiro/skills/pm-prd/SKILL.md` | Product Requirements Document | After discovery |
| `.kiro/skills/pm-stories/SKILL.md` | Epics and user stories | After PRD |
| `.kiro/skills/pm-sprint-report/SKILL.md` | Sprint report analysis | Standalone |
| `.kiro/skills/pm-sprint-sow/SKILL.md` | Sprint Scope of Work | After stories |
| `.kiro/skills/pm-sprint-planning/SKILL.md` | Sprint plan with capacity, backlog, and key dates | After stories or sprint SOW |
| `.kiro/skills/pm-meeting-notes/SKILL.md` | Meeting minutes | Standalone |
| `.kiro/skills/pm-tech-review/SKILL.md` | PM-ready feasibility summary with risks and SA questions | Standalone or after triage |
| `.kiro/skills/pm-release-checklist/SKILL.md` | Go/no-go checklist with verdict — GO, NO-GO, or CONDITIONAL GO | After sprint SOW, or standalone before any release |
...
After each skill output, follow the saving rules from `AGENTS.md`:
