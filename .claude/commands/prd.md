...
Read `.claude/skills/pm-prd/SKILL.md` for the full workflow and output format.
Read `.claude/skills/pm-prd/reference.md` for a worked example if needed.
Read `.claude/skills/pm-prd/brd-guide.md` if the output should follow BRD conventions.
